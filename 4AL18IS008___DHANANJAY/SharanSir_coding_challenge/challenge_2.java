/*1. Write a Java program to find the length of the longest consecutive elements sequence from a given unsorted array of integers.
SAMPLE OUTPUT:
...
/*2. Write a Program in Java to check whether a number is an Armstrong Number or not. 
SAMPLE OUTPUT: 
...
/*3. Write a Java program to segregate all 0s on left side and all 1s on right side of a given array of 0s and 1s.
SAMPLE OUTPUT:
...
/*4. Write a Java program to find the second most frequent character in a given string.
Sample Output:
