1. Program to check for balanced parenthesis with and without using stack is discussed here. You can develop a parenthesis checker without using stack as well. But using stack can have several advantages.
...
2. Program to find the median of two sorted arrays of same size and different size are discussed here. Firstly, let us see what is median of the array?
