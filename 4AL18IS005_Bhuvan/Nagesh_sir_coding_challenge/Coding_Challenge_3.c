#1:
write c/c++ Program to concatenation of strings.
...
#2:
write c/c++ Program  that would sort a list of names in alphabetical order.
Expected Output:    
...
#3:
write c/c++ program for counting of characters, words and lines in a text.
Expected Output:
